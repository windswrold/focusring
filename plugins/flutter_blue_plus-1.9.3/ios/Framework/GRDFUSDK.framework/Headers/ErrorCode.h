...
//for fastDFU
#define CMD_ERR_NOT_4K_ALIGNED (12001)
#define CMD_ERR_OVERLAP (12002)
#define CMD_ERR_CheckSum_NOT_EQUAL (12003)
#define CMD_ERR_FASTDFU_OP_FAILED (12004)
#define CMD_ERR_EXT_FLASH_NOT_EXIST (12005)
#define CMD_ERR_NOT_SUPPORT_FASTDFU (12006)
