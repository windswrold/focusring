...
class FlutterBluePlus {
  ...
  static Stream<void> get onDfuComplete async* {
    Stream<void> stream = FlutterBluePlus._methodStream.stream
        .where((m) => m.method == "onDfuComplete");
    yield* stream;
  }

  static Stream<String> get onDfuError async* {
    Stream<String> stream = FlutterBluePlus._methodStream.stream
  ...
  static Stream<void> get onDfuStart async* {
    Stream<void> stream = FlutterBluePlus._methodStream.stream
        .where((m) => m.method == "onDfuStart");
    yield* stream;
  }

  static Stream<String> get onDfuProgress async* {
    Stream<String> stream = FlutterBluePlus._methodStream.stream
    ...
    try {
      ...
      if (_isScanning.value == true) {
        throw FlutterBluePlusException(
            ErrorPlatform.dart,
            "scan",
            FbpErrorCode.scanInProgress.index,
            'another scan already in progress');
      }
...
class FlutterBluePlusException implements Exception {
  ...
  FlutterBluePlusException(
      this.errorPlatform, this.errorName, this.errorCode, this.errorString);
