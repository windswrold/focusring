...
///
/// {@tool dartpad}
/// This example shows a [KCupertinoPicker] that displays a list of fruits on a wheel for
/// selection.
///
...
class KCupertinoPicker extends StatefulWidget {
  ...
  ///
  /// The [selectionOverlay] widget drawn above the [KCupertinoPicker]'s picker
  /// wheel.
  ...
  @override
  State<StatefulWidget> createState() => _KCupertinoPickerState();
}

class _KCupertinoPickerState extends State<KCupertinoPicker> {
  ...
  @override
  void didUpdateWidget(KCupertinoPicker oldWidget) {
...
/// A default selection overlay for [KCupertinoPicker]s.
///
/// It draws a gray rounded rectangle to match the picker visuals introduced in
/// iOS 14.
///
/// This widget is typically only used in [KCupertinoPicker.selectionOverlay].
...
/// [KCupertinoPicker]s (i.e., other "column"s).
///
/// See also:
///
///  * [KCupertinoPicker], which uses this widget as its default [KCupertinoPicker.selectionOverlay].
class CupertinoPickerDefaultSelectionOverlay extends StatelessWidget {
  ...
  /// elsewhere) of a [KCupertinoPicker].
  ///
  ...
  /// selected item of the underlying [KCupertinoPicker] should remain visible.
...
class KCupertinoPickerDefaultOverlay extends StatelessWidget {
  const KCupertinoPickerDefaultOverlay(
      {Key? key,
      this.margin,
      this.borderRadius,
      this.color,
  ...
  final Text symbolText;

  final double? symbolRight;
